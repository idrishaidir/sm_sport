...
@section('content')
    ...
    <!-- ID untuk Update Realtime Statistik -->
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full text-left border-collapse">
                    ...
                    <tbody class="text-sm">
                        ...
                        @empty
                        <tr><td colspan="4" class="py-10 text-center text-text/50">Belum ada riwayat transaksi.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
            ...
            <div id="upcoming-jadwal" class="bento-card p-6 bg-slate-800 text-white relative overflow-hidden">
                ...
                @if($upcoming)
                    <div class="bg-white/10 rounded-xl p-5 border border-white/20 relative">
                        <!-- Efek animasi sukses lunas realtime -->
                        ...
                        <div class="flex items-center gap-3 mb-4 text-sm">
                            ...
                            Status: <strong class="{{ $upcoming->status == 'Lunas' ? 'text-green-400' : 'text-highlight' }}">{{ $upcoming->status }}</strong>
                        </div>
                        ...
                        @if($upcoming->status == 'Pending' && is_null($upcoming->bukti_bayar))
                            ...
                            @if($sisa_detik > 0)
                                <!-- Data disembunyikan untuk dibaca script JavaScript -->
                ...
                @else
                    <div class="bg-white/5 rounded-xl p-8 text-center border border-white/10">
                        ...
                        <p class="text-sm text-white/50">Tidak ada jadwal aktif.</p>
                    </div>
                @endif
            </div>
